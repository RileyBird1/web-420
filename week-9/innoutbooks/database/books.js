...
module.exports = {
  find:async() => books, // export the books collection
  findOne:async(id) => books.findOne(book => book.id == id),
  insertOne:async(book) => books.insertOne(book),
  deleteOne:async(id) => books.deleteOne({id}),
  updateOne:async(id, book) => books.updateOne(id, book)
};